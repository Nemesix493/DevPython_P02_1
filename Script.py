...
def get_data_from_product_page(url: str) -> dict[str, str]:
    """
    Scrap the url page and extract all the product data and write them
...
def main():
    print(get_data_from_product_page("http://books.toscrape.com/catalogue/a-light-in-the-attic_1000/index.html"))
